...
function Parameter() {
    ...
    return (
        <div className='video2gif-parameter'>
            ...
            <div className='video2gif-parameter-item'>
                <label className='video2gif-parameter-label'>Retraso del gif</label>
